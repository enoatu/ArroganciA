...
require_once __DIR__.'/../lib_es/util.php';
require_once __DIR__.'/../kaiin/kaiin_utils.php';
//require_once("gl_sql.php")
?>
    <!DOCTYPE html>
    <?php require_once __DIR__.'/../kaiin/user_table/user_table_utils.php';
...
<div id="top1"></div>
    <div align="center" id='wrap'>
        ...
        <form name="f1" method="post" action="../kaiin/user_table/redirect.php">
            ...
            try {
                ...
                include ("../kaiin/user_table/disp_table.php");
                echo "</div>";
            ...
            <div><a href="#" id="returnz"><img src="../kaiin/images/top.png" width="40" height="40" alt="top"></a></div>
            <div><a href="#botomn" id="botom"><img src="../kaiin/images/botom.png" width="40" height="40" alt="botom"></a></div>
