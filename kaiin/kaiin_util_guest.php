...
function gronavi($table){
    ...
    共有する</td>
    <td class = "td1" id = "acount"><s>アカウント</s></td>
    </tr>
    <tr class = "tr0" >
    ...
    <td onclick = "document.location.href = '/ArroganciA/kaiin/logout.php?logout&register'; " class = "td1" height = "35" id = "logoutt">会員登録へ</td>
    </tr>
